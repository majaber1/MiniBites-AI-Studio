  ...
  return [
    {
      ...
      creditsState: "EXHAUSTED",
      circuitBreaker: "CLOSED",
      recentSuccessRate: geminiKey ? 0.5 : null,
      rate429: 1.0,
      rate5xx: 0.0,
      p50Ms: 1200,
      p95Ms: 3400,
      ...
      authStatus: geminiKey ? "PASS" : "FAIL",
      ttsStatus: geminiKey ? "WORKING" : "UNKNOWN",
      imageGenStatus: "QUOTA BLOCKED",
      veoStatus: "QUOTA BLOCKED",
      failureScope: "PROJECT / BILLING / QUOTA",
      lastHttpStatus: 429,
      actualSpendUsd: 0.0,
      veoNativeAudioCapability: "SUPPORTED / ALWAYS ON",
      actualVeoAudio: "NOT RUN YET",
    },
    {
      id: "fal-ai-api",
