    ...
    generationMonitor: [
      {
        ...
        selectionReason: directorMode === "auto" ? "Auto Director: Selected for structured story breakdown, 9:16 cinematography, and exact Arabic line preservation." : "Manual Mode: User chosen planner configuration.",
        status: "running",
        realExecution: false,
        startedAt: now,
        fallbackUsed: false,
      },
      {
        ...
        selectionReason: directorMode === "auto" ? "Auto Director: Selected for high-fidelity character anchor generation with 0 identity drift." : "Manual Mode: Explicit image model selected.",
        status: "pending",
        realExecution: false,
      ...
      },
      {
        ...
        selectionReason: directorMode === "auto" ? `Auto Director: Selected ${provider.name} for 9:16 vertical composition and native ambient audio.` : "Manual Mode: Explicit video provider chosen.",
        status: "pending",
        realExecution: false,
        audioMode,
        fallbackUsed: false,
      },
      {
        ...
        selectionReason: directorMode === "auto" ? "Auto Director: Selected for natural Arabic accents (Najdi & Bedouin) and exact sentence preservation." : "Manual Mode: Explicit audio TTS configuration.",
        status: "pending",
        realExecution: false,
        audioMode,
        fallbackUsed: false,
      },
      {
        ...
        selectionReason: "Stitches accepted vertical MP4 video segments with audio sync.",
        status: "pending",
        realExecution: false,
        fallbackUsed: false,
      },
      {
        ...
        selectionReason: "Stores final assembled video for cross-platform distribution.",
        status: "pending",
        realExecution: false,
        fallbackUsed: false,
      },
      {
        ...
        selectionReason: "Dispatches approved video to connected platforms and provides safe manual handoff.",
        status: "pending",
        realExecution: false,
        fallbackUsed: false,
      },
