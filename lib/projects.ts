...
export function builtinProjects(ownerKey: string): StudioProject[] {
  ...
  return [
    ...
    },
    {
      ...
      slug: "future-gahwa",
      name: "Future Gahwa",
      nameAr: "قهوة المستقبل",
      icon: "☕",
      kind: "character_series",
      status: "active",
      description: "A warm humorous Saudi short-form series combining traditional Saudi coffee culture with a small futuristic helper robot (Barq) and coffee master (Abu Nasser).",
      descriptionAr: "سلسلة كوميدية سعودية دافئة تجمع بين أصالة القهوة السعودية وروبوت المستقبل المساعد (برق) مع معلم القهوة (أبو ناصر).",
      defaultProvider: "google",
      bible: {
        ...defaultBible("character_series"),
        concept: "Saudi coffee heritage meets futuristic helpful technology in a bustling Riyadh coffee corner. Abu Nasser demonstrates authentic hospitality while Barq calculates optimal angles.",
        visualStyle: "Warm cinematic modern-traditional Saudi coffee corner. Polished 3D character animation. Subtle glowing cyan holographic accents on Barq contrasting with traditional brass dallah and ceramic finjan.",
        tone: "Warm, respectful, witty, family-friendly humor celebrating Saudi generosity and culture.",
        dialects: ["Saudi Najdi Arabic", "Saudi Digital Arabic"],
        locations: [
          "Modern-traditional Riyadh coffee corner (مجلس / مقهى تراثي حديث)",
          "Coffee prep counter with brass dallah and dates tray",
          "Outdoor shaded seating with warm evening light",
        ],
        defaultAudioMode: "hybrid",
        characters: [
          {
            id: "abu-nasser",
            name: "Abu Nasser",
            displayNameAr: "أبو ناصر",
            role: "Saudi Coffee Master & Host",
            dialect: "Central Saudi (Najdi) Arabic",
            voiceStyle: "Calm, mature, confident, warm Saudi male voice with dry comedic timing.",
            voiceProfile: {
              voiceName: "Orus",
            ...
            visualNotes: "Mature Saudi man in his late 40s, friendly smiling eyes, neat trimmed beard, expressive posture, traditional Saudi clothing.",
            wardrobe: "Crisp white Saudi thobe, red and white shemagh with black agal, warm embroidered farwa for evening.",
            personality: "Calm, confident, deeply experienced in coffee hospitality. Dry witty humor, patient with Barq's algorithms.",
            continuityInstructions: [
              "Always maintain Abu Nasser's authentic Saudi thobe and shemagh.",
              "Pour coffee with right hand while holding dallah in left hand according to Saudi custom.",
              "Preserve calm mature Najdi dialect and unhurried hospitality.",
            ],
          },
          {
            id: "barq",
            name: "Barq",
            displayNameAr: "برق",
            role: "Futuristic Helper Robot & AI Coffee Apprentice",
            dialect: "Saudi Digital Arabic",
            voiceStyle: "Fast, energetic, witty, slightly synthetic robotic modulation, enthusiastic Saudi cadence.",
            voiceProfile: {
              voiceName: "Puck",
            ...
            visualNotes: "Small cute robot (30cm tall) hovering or standing on the counter next to the cups. High-tech pearl white chassis, expressive digital LED eyes, sleek mechanical arms.",
            wardrobe: "Matte pearl white chassis with subtle glowing cyan holographic accents and brass trim matching the dallah.",
            personality: "Overconfident, eager, obsessed with mathematical precision, angles, and algorithms. Easily surprised when human hospitality wins.",
            continuityInstructions: [
              "Barq must always remain a small compact robot (30cm) and never morph into a human.",
              "Expressive LED eyes change icons to convey emotion (questions, exclamation, smiling curves).",
              "Maintain fast enthusiastic synthetic Saudi cadence.",
            ],
          },
        ],
        continuityRules: [
          "Always preserve Abu Nasser's authentic Saudi thobe and shemagh.",
          "Barq must always remain a small compact robot (30cm) and never morph into a human.",
          "The brass dallah is held with the left hand and poured with the right in accordance with Saudi tradition.",
          "Warm golden lighting on the coffee, steam, and dates.",
          "No reuse of MiniBites kitchen assets or Iyal animal character assets.",
        ],
        negativeRules: [
          "No cartoon chefs or dollhouse miniature props",
          "No animal characters from Iyal Al Halal",
          "No Western teapot or incorrect coffee pouring hand",
          "No identity drift or costume swapping",
          "No offensive national or cultural stereotypes",
        ],
      },
      createdAt: stamp,
      updatedAt: stamp,
